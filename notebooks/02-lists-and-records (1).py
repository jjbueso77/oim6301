...
def _():
    #4 List
    Barca_Numbers = [10,11,7,20,12,1,14]
    print(Barca_Numbers)
    return (Barca_Numbers,)


@app.cell
def _(Barca_Numbers):
    #5: Index first number
    Barca_Numbers[0]
    return
...
def _(Barca_Numbers):
    #7 Condition:
    if 10 in Barca_Numbers:
        print("Messi's number is on the list")
    return
...
def _(mo):
    mo.md(r"""
    Visca Barca and Visca Catalunia
    """)
    return
